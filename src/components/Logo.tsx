...
export const Logo: React.FC<LogoProps> = ({
  ...
  // Determine KLTN text gradient based on variant prop
  const getKltnGradient = () => {
    ...
    // Auto mode: bright white in dark mode, dark slate in light mode
  ...
  return (
    ...
    >
      {/* Futuristic 3D Orbiting Global Network Emblem */}
      <div
      ...
      >
        {/* Inner Glassmorphic Container with Ambient Glow */}
        <div className="w-full h-full bg-slate-950/40 rounded-[14px] backdrop-blur-md flex items-center justify-center p-2 relative overflow-hidden">
          {/* Multi-layered Glowing Orbs in Background */}
          ...
          {/* Unique 3D Orbital Network Vector SVG */}
          <svg
            viewBox="0 0 100 100"
            fill="none"
          ...
          >
            ...
            {/* 3D Secondary Counter-Orbit Ring 2 */}
            <ellipse
              cx="50"
              cy="50"
              rx="38"
            ...
            {/* Satellites / Connected User Nodes */}
