...
export function UploadAvatar({
  ...
  useEffect(() => {
    if (typeof value === 'string') {
      // Check if it's a relative path (not a full URL or blob URL)
      const isRelativePath = value && !value.startsWith('http') && !value.startsWith('blob:');
      setPreview(isRelativePath ? `${CONFIG.serverUrl}/${value}` : value);
