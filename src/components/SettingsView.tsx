...
export const SettingsView: React.FC = () => {
  ...
  const handleRevokeDevice = async (deviceId: string) => {
    ...
    try {
      ...
      alert('Không thể thu hồi thiết bị: ' + (err.response?.data?.message || err.message));
    } finally {
      setRevokingId(null);
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-1 bg-white dark:bg-slate-800 rounded-3xl p-3 border border-gray-200 dark:border-slate-700 shadow-sm h-fit space-y-1">
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-2xl text-xs font-bold transition cursor-pointer ${
        ...
        <div className="md:col-span-3 bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
          ...
          {activeSubTab === 'profile' && (
            <div>
              <h3 className="text-sm font-extrabold text-gray-900 dark:text-slate-100 border-b border-gray-100 dark:border-slate-700 pb-3 mb-4">
                Hồ Sơ Cá Nhân (user-service API)
              </h3>

              {profileSuccess && (
                <div className="mb-4 p-3.5 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-2xl flex items-center space-x-2 text-green-700 dark:text-green-300 text-xs font-bold">
              ...
              {profileError && (
                <div className="mb-4 p-3.5 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-2xl flex items-center space-x-2 text-red-700 dark:text-red-300 text-xs font-bold">
              ...
              {loadingProfile ? (
                ...
                <form onSubmit={handleSaveProfile} className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 p-3 bg-gray-50 dark:bg-slate-700/40 rounded-2xl">
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 px-3 py-1.5 rounded-xl border border-gray-200 dark:border-slate-600 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-slate-100 px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-600 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-gray-700 dark:text-slate-300 mb-1">
                  ...
                  {/* Bio Field */}
                  <div>
                    <label className="block text-xs font-bold text-gray-700 dark:text-slate-300 mb-1">Tiểu sử (Bio)</label>
                    <textarea
                      rows={3}
                      value={bio}
                      onChange={(e) => setBio(e.target.value)}
                      placeholder="Giới thiệu đôi nét về bạn..."
                      className="w-full bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-slate-100 px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-600 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none leading-relaxed"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-bold text-gray-700 dark:text-slate-300 mb-1">Giới tính</label>
                      <select
                        value={gender}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-gray-700 dark:text-slate-300 mb-1">Địa điểm / Thành phố</label>
                      <input
                        type="text"
                        value={location}
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-xs font-bold shadow-md transition flex items-center space-x-2 cursor-pointer disabled:opacity-50"
                    >
                      {savingProfile ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between border-b border-gray-100 dark:border-slate-700 pb-3 mb-3">
                  <div>
                    <h3 className="text-sm font-extrabold text-gray-900 dark:text-slate-100 flex items-center space-x-2">
                ...
                {loadingDevices ? (
                  <div className="py-6 text-center text-xs text-gray-400">Đang tải danh sách thiết bị...</div>
                ) : devices.length === 0 ? (
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/30 rounded-2xl text-center text-xs text-gray-400">
                  ...
                  <div className="space-y-2">
                    {devices.map((device) => (
                      <div
                        key={device.id}
                        className="flex items-center justify-between p-3.5 bg-gray-50 dark:bg-slate-700/40 rounded-2xl border border-gray-200/60 dark:border-slate-700"
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-[10px] font-bold px-1.5 py-0.5 rounded-md">
              ...
              <div className="border-t border-gray-100 dark:border-slate-700 pt-5">
                ...
                {mfaStatusMsg && (
                  <div
                    className={`mb-4 p-3.5 rounded-2xl flex items-center space-x-2 text-xs font-bold ${
                ...
                {!mfaQrCode ? (
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      disabled={mfaLoading}
                      className="px-4 py-2 bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-slate-200 rounded-xl text-xs font-bold transition flex items-center space-x-1.5 cursor-pointer"
                    >
                  ...
                  <div className="p-4 bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/60 rounded-3xl space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 bg-white dark:bg-slate-800 p-4 rounded-2xl">
                      {mfaQrCode ? (
                        <img
                          src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(mfaQrCode)}`}
                          alt="MFA QR Code"
                          className="w-36 h-36 rounded-xl border border-gray-200 dark:border-slate-700"
                        />
                      ) : null}
                      <div className="space-y-1.5">
                        <p className="text-xs text-gray-600 dark:text-slate-300 font-semibold">
                          Hoặc nhập khóa bảo mật thủ công:
                        </p>
                        <code className="block bg-gray-100 dark:bg-slate-700 p-2 rounded-xl text-xs font-mono text-emerald-600 dark:text-emerald-400 select-all">
                          {mfaSecret}
                        </code>
                    ...
                    <form onSubmit={handleEnableMfa} className="flex items-center space-x-2">
                      <input
                        ...
                        className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-900 dark:text-slate-100 text-sm font-mono tracking-widest px-4 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 w-44"
                      />
                      <button
                        type="submit"
          ...
          {activeSubTab === 'privacy' && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3.5 bg-gray-50 dark:bg-slate-700/50 rounded-2xl">
                  <div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3.5 bg-gray-50 dark:bg-slate-700/50 rounded-2xl">
                  ...
                  <button
                    onClick={toggleTheme}
                    className="px-4 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-sm transition cursor-pointer"
                  >
                    Chuyển đổi
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-3.5 bg-gray-50 dark:bg-slate-700/50 rounded-2xl">
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 bg-gray-200 dark:bg-slate-600 text-gray-800 dark:text-slate-100 rounded-xl text-xs font-bold hover:bg-gray-300 transition cursor-pointer"
                  >
